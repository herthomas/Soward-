...
TableName = "giveaways_permissions"
...
async def insert(
    ...
    try:
        ...
        try:
            asyncio.create_task(cache_module.giveaways_permissions_cache.update(guild_id=result['guild_id'],data=result))
        except:
            pass
        return result
    except Exception as e:
...
async def update(
    ...
    try:
        ...
        result = await connection.fetchrow(query)
        try:
            asyncio.create_task(asyncio.create_task(cache_module.giveaways_permissions_cache.update(guild_id=result['guild_id'],data=result)))
        except:
            pass
        return result
    except Exception as e:
...
async def delete(
    ...
    try:
        ...
        for r in result:
            try:
                asyncio.create_task(cache_module.giveaways_permissions_cache.delete(guild_id=r['guild_id']))
            except:
                pass
        return result
    except Exception as e:
