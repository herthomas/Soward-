...
async def insert(
    ...
    try:
        ...
        try:
            asyncio.create_task(cache_module.ignore_data_cache.update(guild_id=result['guild_id'],user_id=result['user_id'],channel_id=result['channel_id'],data=result))
        except:
            pass
        return result
    except Exception as e:
...
async def update(
    ...
    try:
        ...
        result = await connection.fetchrow(query)
        try:
            asyncio.create_task(asyncio.create_task(cache_module.ignore_data_cache.update(guild_id=result['guild_id'],user_id=result['user_id'],channel_id=result['channel_id'],data=result)))
        except:
            pass
        return result
    except Exception as e:
...
async def delete(
    ...
    try:
        ...
        for r in result:
            try:
                asyncio.create_task(cache_module.ignore_data_cache.delete(guild_id=r['guild_id'],user_id=r['user_id'],channel_id=r['channel_id']))
            except:
                pass
        return result
    except Exception as e:
